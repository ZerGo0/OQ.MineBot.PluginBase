...
namespace CactusFarmBuilder
{
    ...
    public class PluginCore : IStartPlugin
    {
        public override void OnLoad(int version, int subversion, int buildversion)
        {
            ...
            Setting.Add(new LinkSetting("Don't forget to leave a Like! :)", "", "https://www.minecraftbot.com/plugins.html"));
            
            Setting.Add(new ComboSetting("Layout", "", new []{"CropHopper", "CropHopper Creative Range", "Vanilla"}, 0));
            ...
            layoutPreviews.Add(new LinkSetting("CropHopper Creative Range Layout Showcase", "", "https://i.imgur.com/L15mAwd.png"));
        ...
        {
#if !DEBUG
            if (Setting.At(2).Get<int>() == 1) return new PluginResponse(false, "The 'CropHopper Creative Range' layout isn't available right now.");
#endif
