...
namespace MobAuraPlugin
{
    ...
    public class PluginCore : IStartPlugin
    {
        ...
        {
            Setting.Add(new ComboSetting("Mode", null,
                new[] {"Passive", "Aggressive", "Moving Passive", "Moving Aggressive"}, 0));
            ...
            equipmentGroup.Add(new BoolSetting("Auto equip best armor?",
                "Should the bot auto equip the best armor it has?", true));
        ...
        public override PluginResponse OnEnable(IBotSettings botSettings)
        {
            ...
            if (!botSettings.loadEntities || !botSettings.loadMobs)
        ...
        public override void OnStart()
        {
            ...
            RegisterTask(new Attack((Mode) Setting.GetValue<int>("Mode"), clickGroup.GetValue<int>("Clicks per second"),
                clickGroup.GetValue<int>("Miss rate"), equipmentGroup.GetValue<bool>("Equip best weapon?")));
